...
import com.meetyou.system.common.constant.CacheConstants;
import com.meetyou.system.common.constant.SystemConstants;
import com.meetyou.system.common.util.DateUtils;
import com.meetyou.system.common.util.SecurityUtils;
import com.meetyou.system.converter.UserConverter;
import com.meetyou.system.mapper.SysUserMapper;
...
import com.meetyou.system.service.SysRoleMenuService;
import com.meetyou.system.service.SysRoleService;
import com.meetyou.system.service.SysUserRoleService;
import com.meetyou.system.service.SysUserService;
	...
	public UserInfoVO getCurrentUserInfo() {
		...
		if (CollectionUtil.isNotEmpty(roles)) {
			for (String role : roles) {
				Set<String> rolePerms = (Set<String>) redisTemplate.opsForHash()
					.get(CacheConstants.ROLE_PERMS_PREFIX, role);
